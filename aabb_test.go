...
func TestAABBIntersects(t *testing.T) {
	block := gocraft.NewAABB(gocraft.Vec3d{0, 0, 0}, gocraft.Vec3d{1, 1, 1})
	overlapping := gocraft.NewAABB(gocraft.Vec3d{0.5, 0.5, 0.5}, gocraft.Vec3d{1.5, 1.5, 1.5})
	touching := gocraft.NewAABB(gocraft.Vec3d{1, 0, 0}, gocraft.Vec3d{2, 1, 1})
...
func TestAABBClampYStopsFall(t *testing.T) {
	ground := gocraft.NewAABB(gocraft.Vec3d{0, 0, 0}, gocraft.Vec3d{1, 1, 1})
	player := gocraft.BoxAround(gocraft.Vec3d{0.5, 1.5, 0.5}, 0.6, 1.8)
...
func TestAABBStretchSweepsAlongSign(t *testing.T) {
	swept := gocraft.NewAABB(gocraft.Vec3d{0, 0, 0}, gocraft.Vec3d{1, 1, 1}).Stretch(-2, 0, 3)
