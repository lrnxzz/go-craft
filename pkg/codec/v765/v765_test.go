...
import (
	...
	"github.com/lrnxzz/go-craft/pkg/codec/v765"
)

func _roundTrip(t *testing.T, state gocraft.State, dir gocraft.Direction, packet gocraft.Packet) gocraft.Packet {
	t.Helper()
...
func TestHandshakeRoundTrip(t *testing.T) {
	...
	decoded := _roundTrip(t, gocraft.StateHandshaking, gocraft.Serverbound, original)
...
func TestLoginStartRoundTrip(t *testing.T) {
	...
	decoded := _roundTrip(t, gocraft.StateLogin, gocraft.Serverbound, original)
...
func TestLoginSuccessRoundTrip(t *testing.T) {
	...
	decoded := _roundTrip(t, gocraft.StateLogin, gocraft.Clientbound, original)
...
func TestLoginAcknowledgedIsEmpty(t *testing.T) {
	...
	_roundTrip(t, gocraft.StateLogin, gocraft.Serverbound, &v765.LoginAcknowledged{})
}
