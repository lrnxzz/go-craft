...
func (m *Mojang) Profile(ctx context.Context) (Profile, error) {
	raw, status, err := m._do(ctx, fasthttp.MethodGet, m.ProfileURL, nil)
	if err != nil {
		return Profile{}, err
	}
...
func (m *Mojang) JoinServer(ctx context.Context, profile Profile, serverID string) error {
	...
	raw, status, err := m._do(ctx, fasthttp.MethodPost, m.JoinURL, body)
	if err != nil {
		return err
	}
...
func (m *Mojang) HasJoined(ctx context.Context, username, serverID string) (Profile, error) {
	...
	raw, status, err := m._do(ctx, fasthttp.MethodGet, target, nil)
	if err != nil {
		return Profile{}, err
	}
	if status == fasthttp.StatusNoContent {
...
func (m *Mojang) _do(ctx context.Context, method, target string, body []byte) ([]byte, int, error) {
